...
function WriteTourReview(props) {
    ...
    const getTourReviewInfo = async(memberId, page) => {
        ...
        const response = await axios.get(
            `${process.env.REACT_APP_API_URL}/admin/member/review/member?memberId=${memberId}&page=${page}`,
            {
                headers: {
    ...
    useEffect(() => {
        if(accessToken){
            getTourReviewInfo(props.memberId, page);
        }
    },[])
