                            ...
                            <Collapse key={collapse[hIdx]} in={collapse[hIdx]} sx={{width:"100%"}}>
                                {hItem.flightDTO && (
                                    <Grid container sx={{width:"100%"}}>
                                        ...
                                        <Grid xs={12} item>
                                            <Typography sx={{fontSize: "0.8rem"}}>출발일시 : {hItem.flightDTO.arrivalDateTime}</Typography>
                                        </Grid>
                                        <Grid xs={12} item>
                                            <Typography sx={{fontSize: "0.8rem"}}>도착일시 : {hItem.flightDTO.departDatetime}</Typography>
                                        </Grid>
                                        <Grid xs={12} item>
